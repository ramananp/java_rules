...
|"DTC"|220|"A000000"|"78462F103"|"Direct STP"|14030|"Pending Disposition"|
...
Examples:
|assetTypeName|assetTypeCode|deliveryAcct|cusip|teamName|teamCode|giftType|
|"3rd Party Funds"|380|"A000000"|"302933205"|"3rd Party MF"|14040|"Pending Disposition"|
...
Examples:
|assetTypeName|assetTypeCode|deliveryAcct|cusip|teamName|teamCode|giftType|
|"JPM Fund"|140|"A000000"|"46637K513"|"Direct STP"|14030|"Pending Disposition"|
